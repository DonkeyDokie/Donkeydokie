...
include '../credentials/credentials.php';
  ...
  // $sql = "SELECT * FROM User, Trips, Owns, TravelStyles 
  // WHERE User.UserID = Owns.UserID AND User.SessionKey = '".$session_key."' AND Owns.TripID = Trips.TripID AND Trips.TravelStyleID = TravelStyles.TravelStyleID AND Trips.isOpen = 1";
